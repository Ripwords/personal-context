...
3. **Configure the OAuth consent screen:**
   ...
   - Scopes: add `https://www.googleapis.com/auth/calendar.events` and `https://www.googleapis.com/auth/calendar.readonly`.
...
- **Drag-to-schedule + Google Calendar write-back** — Plan 6 in the roadmap. The unscheduled-todo rail and drag-to-schedule interaction are not yet built; Google Calendar write-back for AI-created events is also pending.
